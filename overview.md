...
**One Family. One Land Cruiser. 100 Countries.**
...
|Trip|Location|Days|
|---|---|---|
|1|Hunza Valley, Pakistan|5-7|
|2|Annapurna/Everest region|5-7|
|2|Sundarbans|2-3|
|3|Remote Laos|3-4|
|**Total**||**~18 days**|

After Trip 3, Starlink covers everything.
...
|13|Feb–May 2034|UK → Ireland → Western Europe|110|🇬🇧🇮🇪🇫🇷🇧🇪🇳🇱🇱🇺🇩🇪|
...
|2039|Morocco → West Africa (coastal)|🇲🇦🇲🇷🇸🇳🇬🇲🇬🇼🇸🇱🇱🇷🇨🇮🇬🇭|
|2040|Central → Southern Africa|🇹🇬🇧🇯🇳🇬🇨🇲🇬🇦🇨🇬🇦🇴🇳🇦🇧🇼🇿🇼🇿🇦|
|2041|East Africa|🇿🇦🇸🇿🇲🇿🇿🇲🇹🇿🇰🇪🇺🇬🇷🇼🇪🇹|
|2042|Egypt → Middle East → Dubai (END)|🇪🇹🇸🇩🇪🇬🇯🇴🇸🇦🇰🇼🇦🇪|

---

# The Vehicle

## 2026 Toyota Land Cruiser 300 GR Sport

**15 Years. 200,000 km. 100 Countries.**

### Base Vehicle

|||
|---|---|
|**Model**|Toyota Land Cruiser 300 GR Sport|
|**Year**|2026|
|**Engine**|3.3L V6 Twin-Turbo Diesel (F33A-FTV)|
|**Power**|302 hp @ 4,000 rpm|
|**Torque**|700 Nm @ 1,600–2,600 rpm|
|**Transmission**|10-Speed Automatic|
|**Drivetrain**|Full-Time 4WD, Torsen LSD, Front + Rear Diff Locks|
|**Exterior**|Crystal Pearl|
|**Interior**|Black Leather-Accented|
|**Fuel Tank**|80L (standard) + 140L long-range auxiliary|
|**Seating**|5 (third row removed)|
|**Purchase Location**|Dubai, UAE|
|**Configuration**|Left-Hand Drive (LHD)|

### Why This Vehicle

**Diesel over Petrol** — Better fuel economy (12–14 L/100km vs 16–18), 700 Nm of low-end torque for sand and mud, diesel available in 95% of countries we'll visit. The twin-turbo V6 is the newest Toyota diesel, replacing the legendary 4.5L V8.

**GR Sport over VXR** — E-KDSS adaptive suspension as standard, front and rear diff locks, sportier driving dynamics. The GR Sport is the expedition-ready trim without the VXR's luxury weight.

**LHD from UAE** — 70% of our route (Europe, Americas, most of Africa) is LHD. UAE has the diesel GR Sport in stock, competitive pricing, and Dubai is the global hub for overland builds.

**Land Cruiser over Competitors** — Global parts availability, legendary reliability, proven expedition platform for 70 years. When something breaks in Tajikistan or the Congo, someone will know how to fix it.

### Build Specification

|Category|Item|SGD|Why|
|---|---|---|---|
|**Protection**|ARB Summit MKII Bull Bar|$3,983|Winch mount, driving light mount, animal strike protection. Steel construction for recovery points.|
||ARB Rear Bar|$1,620|Rear recovery points, jerry can mounts, high-lift jack point. Protects rear quarter panels.|
||ARB Side Rails + Steps|$2,160|Rock sliders protect sills on off-camber terrain. Doubles as hi-lift jack points.|
||ARB Underbody Skids|$2,430|Steel plates protecting sump, transfer case, fuel tank. Essential for rocky terrain in Central Asia and Africa.|
|**Suspension**|Old Man Emu BP-51 Kit|$5,103|Bypass shock technology for loaded touring. 50mm lift, adjustable compression and rebound. Handles the extra 400kg of gear.|
|**Recovery**|Warn Zeon 12-S Winch|$2,228|12,000 lb synthetic rope winch. Lighter than steel cable, safer if it snaps. Self-recovery when there's no one else around.|
||Maxtrax MKII (2 sets)|$810|Sand ladders for soft terrain. Lighter than steel, proven in Sahara crossings. Two sets for deep sand.|
||Recovery Gear Kit|$540|Snatch strap, soft shackles, tree protector, gloves. Complete self-recovery kit.|
|**Air & Water**|Safari Snorkel V-Spec|$743|Raised air intake for water crossings and dust. Keeps engine breathing clean air on dusty African tracks.|
||ARB Twin Compressor|$675|Runs diff lockers, re-inflates tires after sand driving. Essential for daily pressure adjustments.|
|**Fuel**|Long Range Aux Tank (140L)|$2,430|220L total capacity = 1,500+ km range. Critical for Sahara, Outback, Patagonia where fuel stops are 500+ km apart.|
|**Electrical**|REDARC Manager30|$2,025|DC-DC charger + solar regulator + battery monitor. Manages dual battery system, shows state of charge.|
||200Ah LiFePO4 Battery|$1,620|Auxiliary battery powers fridge, lights, devices. Lithium is lighter and handles deep discharge better than AGM.|
||200W Roof Solar|$540|Keeps aux battery topped up when parked. Essential for multi-day camps without driving.|
||Wiring & Harness|$405|Anderson plugs, fuse box, clean installation.|
|**Camping**|iKamper Skycamp 3.0|$5,933|Hard-shell rooftop tent, sleeps family of 4. Sets up in 60 seconds, secure from ground-level threats.|
||iKamper Comfort Bundle|$473|Upgraded mattress and bedding for 4 years of sleeping in it.|
||Alu-Cab 270° Awning|$2,295|Instant shade and rain cover. Wraps around vehicle for large covered area.|
||ARB Elements 60L Fridge|$1,688|Dual-zone fridge/freezer. Keeps food fresh for weeks between towns.|
||80L Water Tank + Pump|$540|Gravity-fed water tank with 12V pump. 4+ days of drinking water.|
|**Lighting**|Baja Designs LP9 Pro (pair)|$2,498|Laser/LED hybrid, 11,025 lumens each. Night driving on unlit African highways. Best-in-class output and reliability.|
||Rock Lights (8pc)|$270|Underbody illumination for night camp setup and trail obstacles.|
|**Tires**|BFG KO2 285/70R17 × 5|$1,890|All-terrain tire with proven sidewall strength. Balanced on-road comfort with off-road capability. Fifth as full-size spare.|
|**Comms**|Starlink Mini + 1yr|$945|Satellite internet anywhere on Earth. Work remotely, stay connected, emergency comms.|
||Garmin InReach Mini 2|$540|SOS beacon + satellite messaging. Emergency rescue in areas without cell coverage.|
|**Storage**|Front Runner Drawers|$2,025|Rear cargo organization. Easy access to gear, secure storage while driving rough terrain.|
||Tools & Spares|$675|Basic tool kit, spare filters, belts, fluids. Self-sufficiency between service stops.|
||Medical Kit|$405|Expedition-grade first aid. Nearest hospital may be days away.|
|**Build**|Labor (Dubai, 2–3 weeks)|$4,050|Professional installation, wiring, testing. One-stop build at Dubai 4×4 specialist.|
||UAE Registration + Insurance|$2,025|Export plates, 1-year insurance for departure.|

**Total Build Cost: SGD $175k** (incl. ~10% contingency)

---

# Traveling with Kids

Trip 1 starts Feb 2027. Baby born late 2026 = ~4 months old at departure.

Babies this age are actually ideal travel companions — they sleep most of the day, breastfeed on demand, and don't need entertainment. No tantrums, no "are we there yet," no screen time negotiations. They're portable, curious, and adaptable. The first year is arguably the easiest window for travel before toddler mobility kicks in.

Plenty of overlanding families start younger. The rhythm of the road — motion, white noise, new stimulation — often suits babies better than a static apartment.

## Practical Notes

- **Driving rhythm:** 2-hour blocks with breaks work for everyone, not just baby
- **Accommodation mix:** More hotels in Trips 1-3 for easier nights, shift to camping as they grow
- **Car seat:** Rear-facing Nuna Pipa RX with ISOFIX (LC300 equipped)
- **Rough roads:** Air down tires, drive slower on corrugated sections — standard overlanding practice anyway

## Healthcare

|Trips|Region|Access|
|---|---|---|
|1-2|Pakistan/India|Good in cities (Islamabad, Delhi, Mumbai)|
|3-5|SE Asia/Oceania|Excellent|
|6-9|South America|Good in cities|
|10-13|USA/Canada/Europe|Excellent|
|14-17|Europe/Caucasus|Good|
|18-21|Africa|Kids 12-15 by then — fully capable travelers|

International health insurance with evacuation coverage required.

## Vaccinations

Yellow fever required for Africa/South America (9+ months). Hep A/B, typhoid, rabies pre-exposure recommended. Travel medicine clinic consult before Trip 1.

---

# Budget

## Monthly Costs (on the road)
...
**Priority:** SIA direct → SIA indirect → Star Alliance direct → Star Alliance indirect → Star Alliance to SIA hub, SIA home

|Trip|Store City|Best Option|Notes|
|---|---|---|---|
...
|---|---|---|
|🇦🇪 UAE|10|Dubai — pick up car, shake down, Sharjah, Abu Dhabi|
|🇴🇲 Oman|12|Muscat, Nizwa, Wahiba Sands, Sur|
...
|🇮🇳 India|35|Amritsar, Delhi, Rajasthan (Jaipur, Jodhpur, Jaisalmer, Udaipur)|

**114 days / 5 countries / ~9,000 km**
...
|🇦🇷 Argentina|14|Up Atlantic coast, Puerto Madryn (penguins)|
|🇦🇷 Argentina|7|Buenos Aires|

**119 days / 2 countries / ~8,000 km**
...
|Country|Days|Highlights|
|---|---|---|
|🇦🇷 Argentina|7|Pick up Buenos Aires, drive north|
|🇦🇷🇧🇷|7|Iguazu Falls (both sides)|
|🇵🇾 Paraguay|5|Asunción|
|🇧🇷 Brazil|21|Pantanal, Bonito, Brasília|
|🇧🇴 Bolivia|21|Santa Cruz, Sucre, Potosí, Uyuni, La Paz|
|🇵🇪 Peru|14|Lake Titicaca, Puno, Arequipa, Colca Canyon|
|🇵🇪 Peru|21|Cusco, Sacred Valley, Machu Picchu|
|🇵🇪 Peru|14|Lima, Nazca Lines, Huacachina|

**110 days / 5 countries / ~9,000 km**
...
**Feb–May 2034 (4 months)**

|Country|Days|Highlights|
|---|---|---|
|🇬🇧 UK|21|Pick up Southampton, London, Cotswolds, Bath, Stonehenge|
|🇬🇧 UK|14|Lake District, York, Edinburgh|
|🇬🇧 UK|10|Scottish Highlands, Isle of Skye|
|⛴️ Ferry|1|Cairnryan → Belfast|
|🇬🇧 UK|7|Northern Ireland (Giants Causeway)|
|🇮🇪 Ireland|14|Dublin, Wild Atlantic Way, Ring of Kerry, Cork|
|⛴️ Ferry|1|Rosslare → Cherbourg|
|🇫🇷 France|14|Normandy, Brittany, Loire Valley, Paris|
|🇧🇪 Belgium|5|Brussels, Bruges, Ghent|
|🇳🇱 Netherlands|7|Amsterdam|
|🇱🇺 Luxembourg|2|Luxembourg City|
|🇩🇪 Germany|14|Mosel, Rhine, Frankfurt, Munich, Romantic Road|

**110 days / 7 countries / ~7,000 km**

**Weather:** Feb–May = European spring. Improving weather.

**Store:** Munich  
**Fly home:** Munich (SIA via Frankfurt)

---

## 🏠 HOME: Jun–Jul 2034 (2 months)

_Settle in Singapore. Child starts GESS Grade 1, August 2034._
...
**Jun–Aug 2036 (7 weeks)**

|Country|Days|Highlights|
|---|---|---|
|🇱🇹 Lithuania|1|Pick up Vilnius|
|🇵🇱 Poland|7|Warsaw, Krakow, Auschwitz|
|🇨🇿 Czechia|5|Prague|
|🇸🇰 Slovakia|3|Bratislava, Tatras|
...
**48 days / 10 countries / ~5,000 km**

**Store:** Podgorica  
**Fly home:** Dubrovnik or Vienna (via Frankfurt)

---

## Trip 16: Eastern Balkans → Turkey → Caucasus

**Jun–Aug 2037 (7 weeks)**

|Country|Days|Highlights|
|---|---|---|
|🇲🇪 Montenegro|1|Pick up Podgorica|
|🇦🇱 Albania|5|Tirana, Albanian Riviera|
...
|🇬🇪 Georgia|7|Tbilisi, Kazbegi, Svaneti|

**49 days / 10 countries / ~6,000 km**

**Store:** Tbilisi  
**Fly home:** Tbilisi or Istanbul (via Dubai)
...
## Trip 18: Morocco → West Africa (coastal)

**Jun–Aug 2039 (7 weeks)**

|Country|Days|Highlights|
|---|---|---|
|🇲🇦 Morocco|8|Pick up, Fes, Marrakech, Sahara, drive south|
|🇲🇷 Mauritania|8|Nouakchott, desert crossing|
|🇸🇳 Senegal|8|Dakar, Saint-Louis|
|🇬🇲 Gambia|3|Banjul|
...
|🇹🇬 Togo|2|Lomé|
|🇧🇯 Benin|3|Ouidah, Cotonou|
|🇳🇬 Nigeria|4|Lagos (transit)|
|🇨🇲 Cameroon|5|Yaoundé, Douala|
|🇬🇦 Gabon|4|Libreville|
|🇨🇬 Congo|3|Brazzaville|
|🇦🇴 Angola|5|Luanda|
|🇳🇦 Namibia|10|Etosha, Sossusvlei, Skeleton Coast|
|🇧🇼 Botswana|6|Okavango Delta, Chobe|
|🇿🇼 Zimbabwe|3|Victoria Falls|
|🇿🇦 South Africa|3|Arrive Johannesburg|
...
|Country|Days|Highlights|
|---|---|---|
|🇿🇦 South Africa|5|Pick up Johannesburg, Kruger|
|🇸🇿 Eswatini|2|Mlilwane|
|🇲🇿 Mozambique|5|Maputo, Tofo|
|🇿🇲 Zambia|4|South Luangwa|
|🇹🇿 Tanzania|10|Serengeti, Ngorongoro, Zanzibar|
|🇰🇪 Kenya|8|Masai Mara, Nairobi|
|🇺🇬 Uganda|5|Kampala, Bwindi gorillas|
|🇷🇼 Rwanda|3|Kigali|
|🇪🇹 Ethiopia|7|Addis Ababa, Lalibela, Simien Mountains|
...
| Country           | Days | Highlights                                                          |
| ----------------- | ---- | ------------------------------------------------------------------- |
| 🇪🇹 Ethiopia     | 3    | Pick up Addis, drive north                                          |
| 🇸🇩 Sudan        | 8    | Khartoum, pyramids of Meroë                                         |
| 🇪🇬 Egypt        | 15   | Abu Simbel, Luxor, Valley of the Kings, Cairo, Pyramids, Alexandria |
| ⛴️ Ferry          | 1    | Nuweiba → Aqaba                                                     |
| 🇯🇴 Jordan       | 8    | Petra, Wadi Rum, Dead Sea, Amman                                    |
| 🇸🇦 Saudi Arabia | 10   | AlUla, Jeddah, Riyadh                                               |
