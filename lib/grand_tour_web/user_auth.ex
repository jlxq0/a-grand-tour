defmodule GrandTourWeb.UserAuth do
  ...
  @remember_me_cookie "_grand_tour_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GrandTourWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
