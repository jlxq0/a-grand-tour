defmodule GrandTourWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GrandTourWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GrandTourWeb.Gettext, "errors", msg, opts)
    end
  end
